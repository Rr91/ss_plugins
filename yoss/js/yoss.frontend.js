...
var yossFrontend = (function () { 'use strict';
	...
	getProductBlock = function (product) {
		var									
			wrapperBlock, wrapperLeft, wrapperRight, productImg, productName, productBrands, productCategory, productPrice, productLink, productCount;
		...
		productCount 	= $('<div/>').addClass('product-count').html('В наличии: '+product.count);
		...
		wrapperLeft.append(productImg, productName, productCount, productBrands, productCategory);
