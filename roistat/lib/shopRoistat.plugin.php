...
HTML;
    ...
    public function frontendSetVisit(array $param)
    {
        ...
        $roistat_form = "Корзина";
        $model = new waModel();
		
        $update = array(
            'roistat_visit' => $roistat_visit,
            'roistat_form'  => $roistat_form,
            'id'            => $param['order_id']
        );
		
        $model->query("UPDATE shop_order SET roistat_visit = s:roistat_visit, roistat_form = s:roistat_form WHERE id = i:id;", $update);
    }
