...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <button type="submit" id="button-dpd" form="form-order" formaction="<?php echo $dpd; ?>" data-toggle="tooltip" title="DPD" class="btn btn-info">DPD</button>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php if($order['parent_id']) echo $order['order_id'].'.'.$order['parent_id'].'.'.$order['num']; else echo $order['order_id']; ?></td>
...
$('input[name^=\'selected\']').on('change', function() {
	$('#button-shipping, #button-invoice, #button-dpd').prop('disabled', true);

	var selected = $('input[name^=\'selected\']:checked');

	if (selected.length) {
		$('#button-invoice').prop('disabled', false);
    $('#button-dpd').prop('disabled', false);
	}
